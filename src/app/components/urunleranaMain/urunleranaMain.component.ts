...
@Component({
  selector: 'app-urunleranaMain',
  templateUrl: './urunleranaMain.component.html',
  styleUrls: ['./urunleranaMain.component.scss']
})
export class UrunleranaMainController implements OnInit {
  kayitlar: any;
