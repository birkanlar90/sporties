...
import { FbServisService1 } from '../../services/fbServis.service';
import { Sonuc } from '../../models/sonuc';
import { Component, OnInit } from '@angular/core';

import { map } from 'rxjs/operators'
@Component({
  selector: 'app-urunlerMain',
  templateUrl: './urunlerMain.component.html',
  styleUrls: ['./urunlerMain.component.css']
})
export class UrunlerMainComponent implements OnInit {
  kayitlar: any;
  secKayit: Kayit = new Kayit();
  sonuc: Sonuc = new Sonuc();
  constructor(
    public fbServis: FbServisService1
  ) { }
