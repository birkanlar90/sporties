...
@Component({
  selector: 'app-markalarMain',
  templateUrl: './markalarMain.component.html',
  styleUrls: ['./markalarMain.component.css']
})
export class MarkalarMainComponent implements OnInit {
  kayitlar: any;
